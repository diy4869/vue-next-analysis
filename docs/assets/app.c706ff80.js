...
function Tt(e) {
  if (
    ...
    t > -1 ? xt.splice(t, 0, e) : xt.push(e), Ft()
  }
}
function Ft() {
...
const Fn = e => '_' === e[0] || '$stable' === e,
  An = e => (E(e) ? e.map($o) : [$o(e)]),
  Mn = (e, t, n) => Qt(e => An(t(e)), n),
  jn = (e, t) => {
    const n = e._ctx
    for (const o in e) {
      if (Fn(o)) continue
      ...
      V = (e, t, n) => {
        ...
        ;(e.vnode = t),
          ...
          ((e, t, n) => {
            ...
            if (s) for (const i in r) Fn(i) || i in l || delete r[i]
          })(e, t.children, n),
          ce(),
          Mt(void 0, e.update),
          ae()
...
function Io(e, t, n = [], o = [], r = [], s = !1) {
  ...
  if (
    (s
      ? c && n.push(c)
      : (n.length && n.forEach(t => Ao(e, t, j)), c && Ao(e, c, j)),
    a)
  )
    for (const m in a) {
      const e = a[m],
...
function Rl() {
  ...
  return (
    ...
    wl.enhanceApp && wl.enhanceApp({ app: t, router: e, siteData: Fr }),
    { app: t, router: e }
  )
}
if (Cr) {
