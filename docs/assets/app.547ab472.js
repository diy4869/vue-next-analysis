...
const h = e => (null == e ? '' : I(e) ? JSON.stringify(e, m, 2) : String(e)),
  ...
  U = e => A(e) && 'NaN' !== e && '-' !== e[0] && '' + parseInt(e, 10) === e,
  N = l(
...
const xe = {
    ...
    has: function(e, t) {
      ...
      return (L(t) && de.has(t)) || ue(e, 0, t), n
    },
    ownKeys: function(e) {
...
function Mt(e, t = null) {
  if (wt.length) {
    for (
      At = t, Ct = [...new Set(wt)], wt.length = 0, $t = 0;
      $t < Ct.length;
      $t++
    )
      Ct[$t]()
    ;(Ct = null), ($t = 0), (At = null), Mt(e, t)
  }
}
function jt(e) {
  if (St.length) {
...
function Rn(e, t, n) {
  const o = this.proxy
  return On(A(e) ? () => o[e] : e.bind(o), t.bind(o), n, this)
}
...
function Ln(e, t, n = Wo) {
  ...
  if ((vn(t, o, n), n)) {
    let e = n.parent
    for (; e && e.parent; ) An(e.parent.vnode) && In(o, t, n, e), (e = e.parent)
  }
}
function In(e, t, n, o) {
  const r = vn(t, e, o, !0)
...
function Qn(e) {
  return (function(e, t) {
    const {
      ...
      E = (e, t, n, o, r, s, l, i, c) => {
        ;(l = l || 'svg' === t.type),
          null == e ? O(t, n, o, r, s, l, i, c) : A(e, t, r, s, l, i, c)
      },
      O = (e, t, o, s, i, c, a, p) => {
        let f, d
        const {
      ...
      A = (e, t, n, o, l, i, c) => {
        ...
        f
          ? L(e.dynamicChildren, f, a, n, o, y, i)
        ...
        d > 0 && (u = !0),
          ...
          null == e
            ...
            : d > 0 && 64 & d && h && e.dynamicChildren
              ? (L(e.dynamicChildren, h, o, s, l, c, a),
      ...
      se = { p: b, um: Y, m: K, r: X, mt: j, mc: T, pc: H, pbc: L, n: te, o: e }
    let le, ie
    t && ([le, ie] = t(se))
...
const go = '__vInternal',
  ...
  bo = ({ ref: e }) =>
    null != e ? (A(e) || lt(e) || T(e) ? { i: Kt, r: e } : e) : null,
...
function Ao(e, t, n = [], o = [], r = [], s = !1) {
  ...
  if (
    (s && A && e.render === y && (e.render = A),
    s ||
      ((To = !1),
      Lo('beforeCreate', 'bc', t, e, N),
      (To = !0),
      Po(e, N, n, o, r)),
    i && Ao(e, i, n, o, r, !0),
    l && Po(e, l, n, o, r),
...
function Po(e, t, n, o, r) {
  for (let s = 0; s < t.length; s++) Ao(e, t[s], n, o, r, !0)
}
function Fo(e, t, n) {
  To = !1
  const o = t.call(n, n)
          ...
          !(function(e, t, n) {
            ...
            if (n)
              if (A(n)) {
                ...
                if (t && !A(t)) for (const e in t) null == n[e] && cr(o, e, '')
              }
...
const Pr = it(
  ((Fr =
    '{"lang":"en-US","title":"Vue3源码解析","description":"A VitePress site","base":"/vue-next-analysis/","head":[],"themeConfig":{"nav":[{"text":"Github","link":"https://github.com/diy4869/vue-next-analysis"}],"sidebar":[{"text":"☆ 个人介绍","link":"/page/my"},{"text":"一些流程图","children":[{"text":"☆ vue-next 渲染流程","link":"/page/flow"}]},{"text":"准备工作","children":[{"text":"☆ 一些基本知识","link":"/page/base"},{"text":"☆ 如何debug","link":"/page/debug"},{"text":"☆ 位运算","link":"/page/bitOperators"},{"text":"☆ 浏览器渲染过程","link":"/page/browserRender"},{"text":"☆ VNode","link":"/page/vnode"},{"text":"☆ AST 抽象语法树","link":"compiler/ast"},{"text":"Rollup","link":""},{"text":"Typescript","link":""}]},{"text":"API","children":[{"text":"lifeCycle 生命周期","link":"/page/lifeCycle"}]},{"text":"初始化渲染","children":[{"text":"☆ createApp","link":"/page/createApp"},{"text":"☆ mount 挂载","link":"/page/mount"},{"text":"☆ render 渲染","link":"/page/render"},{"text":"☆ mountComponent 挂载组件","link":"/page/mountComponent"},{"text":"☆ setupComponent 安装组件","link":"/page/setupComponent"},{"text":"☆ setupRenderEffect 准备渲染","link":"/page/setupRenderEffect"}]},{"text":"compiler 编译","children":[{"text":"☆ baseCompile 基本编译","link":"/compiler/baseCompile"},{"text":"☆ parse 一 初始化解析","link":"/compiler/parse"},{"text":"☆ parse 二 解析子节点","link":"/compiler/parseChildren"},{"text":"☆ parse 三 一些解析工具函数","link":"/compiler/utils"},{"text":"☆ parse 四 解析标签","link":"/compiler/parseTag"},{"text":"☆ parse 五 解析属性","link":"/compiler/parseAttribute"},{"text":"☆ parse 六 解析文本","link":"/compiler/parseText"},{"text":"☆ parse 七 解析元素","link":"/compiler/parseElement"},{"text":"☆ parse 八 结束","link":"/compiler/parseEnd"},{"text":"☆ transform 初始化","link":"/compiler/transform"},{"text":"☆ transform 创建转换器上下文","link":"/compiler/createTransformContext"},{"text":"☆ transform 转换节点","link":"/compiler/traverseNode"},{"text":"☆ transform 一些转换的工具函数","link":"/compiler/transformUtils"},{"text":"☆ transform 转换元素","link":"/compiler/transformElement"},{"text":"☆ transform createVNodeCall","link":"/compiler/createVNodeCall"},{"text":"☆ transform 静态提升","link":"/compiler/staticHoist"},{"text":"☆ transform 创建根节点代码生成","link":"/compiler/createRootCodegen"},{"text":"☆ transform 结束","link":"/compiler/transformEnd"},{"text":"☆ generate 一些生成函数","link":"/compiler/generateFunction"},{"text":"☆ generate 一","link":"/compiler/generateOne"},{"text":"☆ generate 二","link":"/compiler/generateTwo"},{"text":"☆ generate 模板转render function","link":"/compiler/generateThree"},{"text":"☆ generate 结束","link":"/compiler/generateEnd"}]},{"text":"渲染 render","children":[{"text":"patch 渲染更新DOM","link":"/directive/v-show"}]},{"text":"内置组件 components","children":[{"text":"keepAlive","link":"/components/keepAlive"},{"text":"suspense","link":"/components/suspense"},{"text":"teleport","link":"/components/teleport"}]},{"text":"响应式","children":[{"text":"reactive","link":""},{"text":"ref","link":""},{"text":"...","link":""}]}]},"locales":{},"customData":{}}'),
  Ze(JSON.parse(Fr)))
)
var Fr
function Mr() {
...
var bl = Kn({
  expose: [],
  setup(e) {
    const t = Gn(() => import('./Home.07e909de.js')),
      n = () => null,
      o = n,
      r = n,
      s = n,
                  ...
                  e.ctrlKey ||
                    ...
                    l === a.pathname
                      ? i &&
                        ...
                        Ar(t, i, t.classList.contains('header-anchor')))
                      : o(n))
                }
              },
              { capture: !0 }
